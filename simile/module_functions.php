...
function simile_buttons($preview){
	...
	if($preview!==""){
		...
		?><input type="submit" class="simile_button" name="preview" value="<?PHP echo SIMILE_PREVIEW; ?>" />
		<input type="submit" class="simile_button" name="save" value="<?PHP echo SIMILE_CONTINUE; ?>" />		
		<?PHP
...
function simile_zone_label($counter, $zone_label, $data){
	...
	?>
	  ...
	  <label><?PHP echo SIMILE_COLOUR; ?></label><input class="color" type="text" length="6" name="simile_zone_label_colour_<?PHP echo $counter; ?>" value="<?PHP if(isset($zone_label['simile_zone_label_colour_' . $counter])){ echo $zone_label['simile_zone_label_colour_' . $counter]; } ?>" /><br />
	  <label><?PHP echo SIMILE_OPACITY; ?></label><input type="text" length="3" name="simile_zone_label_opacity_<?PHP echo $counter; ?>" value="<?PHP if(isset($zone_label['simile_zone_label_opacity_' . $counter])){ echo $zone_label['simile_zone_label_opacity_' . $counter]; } ?>" /><br />		
	  <label><?PHP echo SIMILE_REMOVE; ?></label> <input type="checkbox" length="10" name="simile_zone_label_delete_<?PHP echo $counter; ?>" />			  		
	</div>
	<?PHP
...
function simile_event($counter, $event, $data){
	...
	?><label><?PHP echo SIMILE_EVENT_TITLE; ?></label><input class="required" type="text" size=100 length=100 style="width:100%" name="simile_event_title_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_title_' . $counter])){ echo stripslashes($event['simile_event_title_' . $counter]); } ?>" /><br />
	<label><?PHP echo SIMILE_EVENT_DESCRIPTION; ?></label><textarea class="required" style="width:100%; height:50px" name="simile_event_description_<?PHP echo $counter; ?>"><?PHP if(isset($event['simile_event_description_' . $counter])){ echo stripslashes($event['simile_event_description_' . $counter]); } ?></textarea><br />
	<label><?PHP echo SIMILE_EVENT_START; ?></label><input class="required" type="text" length="20" id="simile_event_start_<?PHP echo $counter; ?>" name="simile_event_start_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_start_' . $counter])){ echo $event['simile_event_start_' . $counter]; } ?>" />	
	<label><?PHP echo SIMILE_EVENT_LATEST_START; ?></label><input type="text" length="20" id="simile_event_lateststart_<?PHP echo $counter; ?>" name="simile_event_lateststart_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_lateststart_' . $counter])){ echo $event['simile_event_lateststart_' . $counter]; } ?>" /><br />
	<label><?PHP echo SIMILE_EVENT_EARLIEST_END; ?></label><input type="text" length="20" id="simile_event_earliestend_<?PHP echo $counter; ?>" name="simile_event_earliestend_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_earliestend_' . $counter])){ echo $event['simile_event_earliestend_' . $counter]; } ?>" /> 
	<label><?PHP echo SIMILE_EVENT_END; ?></label><input type="text" length="20" id="simile_event_end_<?PHP echo $counter; ?>" name="simile_event_end_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_end_' . $counter])){ echo $event['simile_event_end_' . $counter]; } ?>" /><br />
	<script type="text/javascript">
	...
	<label><?PHP echo SIMILE_EVENT_DURATION_EVENT; ?></label></label><input type="checkbox" name="simile_event_durationevent_<?PHP echo $counter; ?>" <?PHP if(isset($event['simile_event_durationevent_' . $counter])){ if($event['simile_event_durationevent_' . $counter]=="on"){ echo " checked "; } } ?> /><br />								
	<label><?PHP echo SIMILE_EVENT_LINK; ?></label><input style="width:100%" type="text" length="100" name="simile_event_link_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_link_' . $counter])){ echo  $event['simile_event_link_' . $counter]; } ?>" /><br />
	<label><?PHP echo SIMILE_EVENT_IMAGE; ?></label><input style="width:100%" type="text" length="100" name="simile_event_image_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_image_' . $counter])){ echo $event['simile_event_image_' . $counter]; } ?>" /><br />				
	<label><?PHP echo SIMILE_COLOUR; ?></label><input class="color" type="text" length="6" name="simile_event_color_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_color_' . $counter])){ echo $event['simile_event_color_' . $counter]; }else{ echo "000000"; } ?>" /><br />
	<label><?PHP echo SIMILE_TEXT_COLOUR; ?></label><input class="color" type="text" length="6" name="simile_event_textcolor_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_textcolor_' . $counter])){ echo $event['simile_event_textcolor_' . $counter]; }else{ echo "000000"; } ?>" /><br />
	<label><?PHP echo SIMILE_OPACITY; ?></label><input type="text" length="3" name="simile_event_opacity_<?PHP echo $counter; ?>" value="<?PHP if(isset($event['simile_event_opacity_' . $counter])){ echo $event['simile_event_opacity_' . $counter]; } ?>" /><br />
	<label><?PHP echo SIMILE_ZONE_APPEAR_EVENTS; ?></label>
